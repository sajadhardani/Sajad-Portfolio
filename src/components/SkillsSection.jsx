...
const categories = [
  { key: "all", label: "skill.all" },
  { key: "frontend", label: "skill.frontend" },
  { key: "backend", label: "skill.backend" },
  { key: "tools", label: "skill.tools" },
];
    ...
    <section id="skills" className="py-24 px-4 relative bg-secendary/30  ">
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center ">
          {t("skill.1")} <span className="text-primary"> {t("skill.11")} </span>
        </h2>
            ...
            >
              ...
              <div>
                <div className="w-full bg-secondary/50 h-2 rounded-full overflow-hidden">
                  <div
                    className="bg-primary h-2 rounded-b-full origin-left animate-[grow_1.5s_ease-out]"
